...
def read_login_header(input_url, input_action_list, input_cookie=None, headless_mode=False):
    ...
    # 6. try login
    driver_2 = webdriver.Chrome(options=chrome_options, desired_capabilities=capabilities)
...
if __name__ == '__main__':
    ...
    print(read_get_page("https://www.example.com", headless_mode=True))
    # print(read_bing_search('LOGFLOWS'))
